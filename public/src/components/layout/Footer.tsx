...
/**
 * Footer — JulesX Editorial
 * Reference: screen1 footer — minimal with links + brand + social
 * Warm cream background, editorial typography.
 */
...
export default function Footer() {
  return (
    <footer className="bg-bg border-t border-border py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <p className="text-text-light text-xs tracking-[0.05em]">
            {SITE.copyright()}
          </p>
        </div>
      </div>
