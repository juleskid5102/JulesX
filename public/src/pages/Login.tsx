...
/**
 * Login — Unified with Register (split-panel layout)
 * Based on 10-register.html style → adapted for login
 * NOW WIRED to Firebase Auth via useAuth hook
 */
      ...
      <main className="min-h-screen flex flex-col md:flex-row pt-20">
          ...
          <div className="relative z-10">
            ...
            <ul className="space-y-6 max-w-md">
              <li className="flex items-center gap-4 text-slate-400 font-normal text-lg">
                ...
                Xem tiến độ dự án realtime
              </li>
              <li className="flex items-center gap-4 text-slate-400 font-normal text-lg">
                <span className="material-symbols-outlined text-primary text-[24px]">check</span>
                Tải hợp đồng &amp; báo giá
              </li>
              <li className="flex items-center gap-4 text-slate-400 font-normal text-lg">
                <span className="material-symbols-outlined text-primary text-[24px]">check</span>
        ...
        <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-8 lg:px-24 py-20">
          <div className="max-w-[480px] w-full mx-auto">
            <h3 className="font-heading text-4xl text-black mb-10">Đăng Nhập</h3>
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="relative group">
                ...
                <a
                  href="#"
                  className="absolute right-0 top-4 text-xs font-bold text-slate-400 hover:text-primary transition-colors uppercase tracking-widest"
                >
                  Quên?
                </a>
              </div>
